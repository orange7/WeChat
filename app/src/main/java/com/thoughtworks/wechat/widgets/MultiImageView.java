...
import com.thoughtworks.wechat.utils.DensityUtil;
...
public class MultiImageView extends LinearLayout {
	...
	// 照片的Url列表
	private List<Tweet.ImagesBean> imagesList;
	...
	public void setList(List<Tweet.ImagesBean> lists) throws IllegalArgumentException {
		if(lists==null){
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		Tweet.ImagesBean photoInfo = imagesList.get(position);
		...
		Glide.with(getContext()).load(photoInfo.getUrl()).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
